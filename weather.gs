//ADDRESS GET WEATHER
  function initWeatherLocation(address, lat, lon) {
  var address = address? address : '112台灣台北市北投區知行路316巷22弄1',
      lat = lat? lat : '25.121812156861246',
      lon = lon? lon : '121.46874602884054';
   
    var response = UrlFetchApp.fetch('https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&units=metric&APPID=81fa3d055a08e1d5d1bae755612d14ea');
          ...
          contents: [{
            ...
            color: "#132C7B",
              action: {
                 type: "uri",
                label: '相關資訊',
                uri: 'https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&units=metric&APPID=0a40a77d91018a9eebd11c12c65c8ceb'
              }
          }]
        }
      }
